...
import { usernameSubject } from '../../../p2p/identity/state'
import { currentSessionSubject, sessionForRemoteUser, sessionListSubject } from '../../../p2p/session/state'
import { ProcessedChatMessage } from '../../../p2p/messages/types';
import { encryptAndSendMessage } from '../../../p2p/messages/functions';
import { ChatSession } from '../../../p2p/session/types';
import { startSession } from '../../../p2p/session/functions';
import { createIdentity } from '../../../p2p/identity/functions';
...
function ComposeMessage(props: ComposeMessageProps): JSX.Element {
  ...
  const sendMessage = async (to: string, message: string) => {
      encryptAndSendMessage(to, message, false)
      setMessage('')
  }
