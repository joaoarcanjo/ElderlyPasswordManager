...
import { credencialsCollectionName, defaultCredencials, elderlyCollectionName, keyCollectionName, keyDocumentName, privateCaregiversDocumentName, privateCollectionName, updateDataCredencial } from './constants';
